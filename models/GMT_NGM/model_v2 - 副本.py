import torch
import itertools
from models.GMT_NGM.association import AssociationLayer
...
from models.GMT_NGM.gnn import GNNLayer
from src.lap_solvers.sinkhorn import Sinkhorn
from src.lap_solvers.hungarian import hungarian
from torch import nn
from src.utils.config import cfg
import copy
from models.GMT_NGM.transformconv import TransformerConvLayer
from models.GMT_NGM.position_encoding import AGNN, GATv2
...
def normalize_over_channels(x, dim=1):
    channel_norms = torch.norm(x, dim=dim, keepdim=True)
...
class Net(GMT):
    def __init__(self):
        ...
        if cfg.ATTN.SWITCH == True:
            self.classifier = nn.Linear(cfg.NGM.GNN_FEAT[-1], 1)
        else:
