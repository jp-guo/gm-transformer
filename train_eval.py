...
def train_eval_model(model,
    ...
    alpha = cfg.TRAIN.ENTROPY_ALPHA
    gamma = cfg.TRAIN.ENTROPY_GAMMA
    alpha_pow = 0
        ...
        for inputs in dataloader['train']:
            ...
            with torch.set_grad_enabled(True):
                ...
                if cfg.PROBLEM.TYPE == '2GM':
                    ...
                    elif cfg.TRAIN.LOSS_FUNC == 'entropyperm':
                        criterion.gamma = gamma * (alpha ** alpha_pow)
                        loss = criterion(outputs['ds_mat'], outputs['gt_perm_mat'], *outputs['ns'])
                    ...
                    if cfg.TRAIN.LOSS_FUNC in ['perm', 'entropyperm', 'ce' 'hung']:
...
if __name__ == '__main__':
    ...
    elif cfg.TRAIN.LOSS_FUNC.lower() == 'entropyperm':
        criterion = EntropyPermutationLoss()
    ...
    if cfg.TRAIN.OPTIMIZER.lower() == 'sgd':
        optimizer = optim.SGD(model_params, lr=cfg.TRAIN.LR, momentum=cfg.TRAIN.MOMENTUM, nesterov=True, weight_decay=cfg.TRAIN.WEIGHT_DECAY)
    elif cfg.TRAIN.OPTIMIZER.lower() == 'adam':
        optimizer = optim.Adam(model_params, lr=cfg.TRAIN.LR, weight_decay=cfg.TRAIN.WEIGHT_DECAY)
    else:
