...
class XCiT(nn.Module):
    ...
    def forward_features(self, x):
        ...
        nodes, edges = torch.empty(x.shape), torch.empty(x.shape)
    ...
    def forward(self, x):
        ...
        nodes, edges = nodes.reshape((x.shape[0], -1, num_patches, num_patches)), \
                       edges.reshape((x.shape[0], -1, num_patches, num_patches))
